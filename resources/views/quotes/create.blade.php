...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Create Kutipan</div>
                ...
                <div class="card-body">
                    ...
                    <form action="/quotes" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" placeholder="Judul kutipan" value="{{ old('title') }}">
                      </div>

                      <div class="form-group">
                        <label for="subject">Isi Kutipan</label>
                        <textarea name="subject" class="form-control" rows="8">{{ old('subject') }}</textarea>
                      </div>                      
                      ...
                      {{ csrf_field() }}
                      <div class="lead row text-right">
                        <div class="col-md-12">
                            <a class="btn btn-secondary" href="/quotes" >Cancel</a>                            
                            <button type="submit" class="btn btn-primary">Submit Kutipan</button>
                        </div>
                      </div>
                    </form>
                </div>
